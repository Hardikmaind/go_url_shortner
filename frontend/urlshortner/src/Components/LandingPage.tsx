const posts = [
  ...
  },
  {
    ...
    title: " Good Service",
    href: "#",
    description: "best url shortner out there. This is even free",
    date: "Mar 16, 2024",
    datetime: "2020-03-16",
    category: { title: "Engineering", href: "#" },
    author: {
    ...
    <div className="bg-gradient-to-tr  from-white-800 via-purple-300 to-green-400  mx-5 lg:mx-0 sm:py-10 rounded-lg">
      <div className="mx-auto max-w-7xl  px-6 lg:px-8">
        <div className="mx-auto max-w-2xl  lg:mx-0">
          <h2 className="text-pretty  font-semibold tracking-tight text-gray-900 sm:text-3xl">
            About ShortKing
          </h2>
          <p className=" text-lg/8 text-purple-700 font-bold">
            Shorten URLs for Free, No Login, Unlimited Convenience!
          </p>
        </div>
            ...
            >
              ...
              <div className="relative mt-8 flex items-center gap-x-4">
                ...
                <div className="text-sm/6">
                  ...
                  <p className="text-white underline  underline-offset-3">
                    {post.author.role}
                  </p>
                </div>
              </div>
